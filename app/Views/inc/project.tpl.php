<section class="projects" id="projects">
  ...
  <div class="projects-group">
    ...
    <div class="my-projects">
      ...
      <div class="my-projects-text-ocoeur scroller-left">
        <div class="text-ltr">
          ...
          <ul>
            ...
            <li>La partie Front-end a été réalisée en <span class="bold">Twig</span> / <span class="bold">Javascript</span> / <span class="bold">CSS3</span>.</li>
      ...
      <div class="my-projects-img-ocoeur">
        <img class="ocoeur" src="<?= $absoluteUrl ?>assets/images/reflex.png" alt="image du site ocoeur2soi">
        <h3><a href="https://www.ocoeur2soi.fr/" target="_blank">Voir le site</a></h3>
      </div>
    </div>
